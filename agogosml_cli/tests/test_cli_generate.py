...
def test_generate():
    ...
    # You want to test the following commands (lets start with one test case for now):
    # * agogosml generate 
    ...
    #       * should generate .env file, datapipeline.yml, cicd.yml, Pipfile, tests/e2e/, tests/validation exist
